...
NormalPlayerInput
    ...
    push    af
    bit     1,a
    call    z,select_gun    ; [Y=]  = MSX 1
    pop     af
    push    af
    bit     2,a
    call    z,select_chaingun    ; [WINDOW]  = MSX 2
    pop     af
    bit     3,a
    call    z,select_shotgun     ; = MSX 3
    ...
    push af
    bit 7,a
    call    z,straff_left ; left straff [ALPHA] = MSX Z
    pop af

    bit    5,a
    call    z,straff_right ; right straff [X,T,0,n] = MSX X
...
;    pop    af
    ...
    out (#aa),a
    in a,(#a9)
    bit    0,a    ; run [MODE] TODO: see why it crashes on a ti-82 rom =< 19.0  = MSX SHIFT
...
findep2
/*
    ld    a,%00001000    ; je sais pas si 1er out sert
    out    ($03),a
    ld    a,%00001111
    out    ($03),a
